...
const PriceList = () => {
  ...
  const categories = ['ecommerce-solution', 'laravel-ecommerce', 'php-ecommerce', 'codeigniter-ecommerce']; // Hardcoded category names
  const categoryIds = [24, 25, 27, 26]; // Hardcoded category IDs
