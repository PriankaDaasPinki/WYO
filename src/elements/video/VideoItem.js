...
function VideoItem({galleryItem}) {
    ...
    return (
        <div>
            <div className="rn-gallery icon-center video-gallery-content bg_image" data-black-overlay="7" style={{backgroundImage: `url(${process.env.PUBLIC_URL}/images/about/about-contact.jpg)`}}>
